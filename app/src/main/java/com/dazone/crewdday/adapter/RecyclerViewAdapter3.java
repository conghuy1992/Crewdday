...
public class RecyclerViewAdapter3 extends RecyclerView.Adapter<RecyclerViewAdapter3.MyViewHolder> {
    String TAG = "RecyclerViewAdapter3";
    ...
    public RecyclerViewAdapter3(List<String> moviesList, int temp) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DDayActivity.instance.startOrganization3();
            }
        });
        holder.img_delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DDayActivity.instance.remove_pos3(position);
            }
        });
    }
